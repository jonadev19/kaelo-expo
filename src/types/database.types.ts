...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      find_businesses_near_geojson: {
        Args: { p_geojson: Json; p_radius_m?: number }
        Returns: {
          address: string
      ...
      get_active_businesses: { Args: { p_type?: string }; Returns: Json[] }
      get_business_detail: { Args: { p_business_id: string }; Returns: Json }
      get_published_routes: {
        Args: {
          p_difficulty?: string
      ...
      get_route_detail: { Args: { p_route_id: string }; Returns: Json }
      ...
      request_route_refund: {
        Args: { p_buyer_id: string; p_purchase_id: string; p_reason: string }
        Returns: undefined
      }
      search_businesses: {
